defmodule ExLinguaSentence.Worker do
    use ExActor.GenServer, export: :lingua_sentence_en

    @root_dir File.cwd!
    @share_dir "#{@root_dir}/share"

    defstart start_link( language ) do
        initial_state( load_nonbreaking_prefix_file( language ) )
    end
